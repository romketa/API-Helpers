 ...
 * 2022-09-20T17:06:51.904+04:00
 * Generated source version: 3.3.4
 *
 */
@WebServiceClient(name = "NumberConversion",
                  wsdlLocation = "file:/D:/Personal/Automation/API_Helper%202.0/API-Helpers/src/test/resources/wsdl/numberconversion.wsdl",
...
public class NumberConversion extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Personal/Automation/API_Helper%202.0/API-Helpers/src/test/resources/wsdl/numberconversion.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(NumberConversion.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/Personal/Automation/API_Helper%202.0/API-Helpers/src/test/resources/wsdl/numberconversion.wsdl");
        }
        WSDL_LOCATION = url;
    }
